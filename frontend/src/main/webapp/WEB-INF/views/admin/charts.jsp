...
<body id="page-top">
	...
	<script src="${pageContext.servletContext.contextPath }/assets/js/admin/demo/chart-bar-demo.js"></script>
	<script src="${pageContext.servletContext.contextPath }/assets/js/admin/demo/chart-pie-demo.js"></script>
